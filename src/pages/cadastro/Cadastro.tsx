...
function Cadastro() {
  ...
  async function cadastrarNovoUsuario(e: FormEvent<HTMLFormElement>){
    ...
    if(confirmarSenha === usuario.senha && usuario.senha.length >= 8){
      ...
      ToastAlerta("Dados de usuário inconsistentes! Verifique as informações de cadastro", 'erro')
      setUsuario({
        ...usuario,
        senha: ""
      });
      ...
      w-full min-h-screen bg-cover bg-center"></div>
        ...
        onSubmit={cadastrarNovoUsuario}>
          ...
          <div className="flex flex-col w-full">
            ...
            name="nome"
            placeholder="Nome"
            className="border-[2px] border-slate-700 rounded p-2"
            value={usuario.nome}
          ...
          <div className="flex justify-around w-full gap-8">
            ...
            hover:bg-red-700 w-1/2 py-2 flex justify-center"
