...
function AtualizarPerfil() {
    ...
    // Reset toda vez que carregar formulário
    useEffect(() => {
        setUser({} as Usuario)
        setConfirmarSenha("")
        setIsLoading(false)
                            ...
                            <form onSubmit={atualizarUsuario} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 border-[2px] border-slate-700 rounded  focus:outline-none transition-colors"
                                        value={user.nome || ""}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 border-[2px] border-gray-200 rounded bg-gray-50 cursor-not-allowed"
                                        disabled
                                        value={user.usuario || ""}
                                        onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)}
                                    />
